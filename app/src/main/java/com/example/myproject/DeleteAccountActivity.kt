...
import com.example.myproject.databinding.ActivityDeleteAccountBinding
                        ...
                        override fun onDataChange(snapshot: DataSnapshot) {
                            ...
                            refUsers.child(myUid!!).removeValue()
                                ...
                                .addOnFailureListener {e->
                                    ...
                                    progressDialog.dismiss()
                                    Utils.toast(this@DeleteAccountActivity,"Failed to delete user data due to ${e.message}")
                                    startMainActivity()
                                }
                        }
